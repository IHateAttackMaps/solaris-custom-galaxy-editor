...
import type { GeneratorType, PlayerDistribution } from "./Generator"
...
export interface Settings {
    ...
    generation: {
        defaultGeneratorId: GeneratorType['id'];
        defaultPlayerCount: number;
        defaultStarsPerPlayer: number;
        defaultGeneratePlayers: 'enabled' | 'disabled';
        defaultPlayerDistribution: PlayerDistribution;
        defaultStartingStars: number;
        defaultHyperspaceRange: number;
